...
var mouseBtn;
(function (mouseBtn) {
    mouseBtn[mouseBtn["none"] = -1] = "none";
    mouseBtn[mouseBtn["rotModel"] = 2] = "rotModel";
    mouseBtn[mouseBtn["rotCamera"] = 0] = "rotCamera";
    mouseBtn[mouseBtn["moveModel"] = 1] = "moveModel";
})(mouseBtn || (mouseBtn = {}));
var keyboardKey;
...
class Application {
    ...
    static getInstance(canvas, textarea) {
    ...
    get hasScene() { return this._scene != null; }
    get mouseDown() { return this._mouseDown; }
    get mouseLocked() { return this._mouseLocked; }
    set mouseDown(btn) { this._mouseDown = btn; }
    set mouseLocked(locked) { this._mouseLocked = locked; }
    ...
    updateJSON() {
        ...
        this._color = new Color((_a = this._scene) === null || _a === void 0 ? void 0 : _a.material, (_b = this._scene) === null || _b === void 0 ? void 0 : _b.lights);
...
Application._singleInstance = null;
document.addEventListener("DOMContentLoaded", () => {
    ...
    canvas.addEventListener("mousemove", (event) => {
        if (app.mouseDown == mouseBtn.none)
            return;
